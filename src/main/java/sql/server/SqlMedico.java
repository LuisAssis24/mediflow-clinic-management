    ...
    public static void criarNovaEntrada(EntradaRegistoClinico entrada){
        ...
        if (conexao != null){
            try{
                ...
                statement.setInt(1, entrada.getNumeroSns());
                statement.setInt(2, entrada.getIdMedico());
                statement.setString(3, entrada.getData());

                String assuntoStr = listToString(entrada.getAssunto());
                String tratamentoStr = listToString(entrada.getTratamentos());

                statement.setString(4, assuntoStr);
